...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'cms_placeholder', 'default_width')

        # Adding field 'Placeholder.glossary'
        db.add_column(u'cms_placeholder', 'glossary',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'cms_placeholder', 'default_width',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Deleting field 'Placeholder.glossary'
        db.delete_column(u'cms_placeholder', 'glossary')
