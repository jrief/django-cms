...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Page.menu_node'
        db.add_column(u'cms_page', 'menu_node',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Page.menu_node'
        db.delete_column(u'cms_page', 'menu_node')
    ...
    models = {
        ...
        'cms.page': {
            ...
            'menu_node': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
